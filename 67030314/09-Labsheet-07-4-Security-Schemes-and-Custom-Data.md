...
![Lab07 4.1](images/Lab07-4-1.png)

![Lab07 4.2](images/Lab07-4-2.png)
...
| :---------------------- | :-------------- | :----------------------------------------------------------------------------------------------------- | :----------------------------------------------------------------------------------- |
| **1. ป้อน PoP ผิดพลาด** | `wrong1234`     | ขึ้นแจ้งเตือนข้อผิดพลาด (Authentication Failed / Incorrect PoP) ไม่สามารถผ่านเข้าหน้าตั้งค่า Wi-Fi ได้ | E (...) app: Received incorrect username and/or PoP for establishing secure session! |
| **2. ป้อน PoP ถูกต้อง** | `abcd1234`      | เชื่อมต่อสำเร็จผ่านเข้าสู่หน้าเลือกเครือข่าย Wi-Fi ได้ปกติ                                             | I (...) app: Secured session established!                                            |
| **3. ส่ง Custom Data**  | `TEST_DATA_999` | ขึ้นสถานะตอบกลับสำเร็จ (ACK / Success) จากอุปกรณ์                                                      | I (...) app: Received custom data: TEST_DATA_999                                     |
...
```text
ป้องกันการโจมตีแบบ Rogue Provisioning และ Man-in-the-Middle Attack เนื่องจากผู้โจมตีต้องมีรหัส PoP ที่ตรงกับอุปกรณ์เท่านั้นจึงจะสามารถแลกเปลี่ยนคีย์ความปลอดภัยและสถาปนาเซสชันได้
```
2. หากไม่มีการใช้ PoP (เช่น ใน Security 0) ผู้โจมตีที่อยู่ในรัศมีสัญญาณบลูทูธสามารถทำสิ่งใดกับอุปกรณ์ได้บ้าง?
```text
ผู้โจมตีสามารถเชื่อมต่อเข้าหาอุปกรณ์ได้ทันทีโดยไม่ต้องผ่านการยืนยันตัวตน ซึ่งเปิดโอกาสให้สามารถส่ง SSID และ Password ปลอมเพื่อดักจับข้อมูล หรือบังคับให้อุปกรณ์เชื่อมต่อเข้ากับ Wi-Fi ของผู้โจมตีได้โดยตรง
```
3. ในการประยุกต์ใช้งานเชิงพาณิชย์จริง เราสามารถนำ **Custom Data Endpoint** ไปใช้ส่งข้อมูลประเภทใดได้อีกบ้าง (ยกตัวอย่าง 2 กรณี)?
```text
กรณีที่ 1 ส่ง MQTT Broker URL / Credentials และ Client ID เพื่อให้อุปกรณ์นำไปใช้เชื่อมต่อกับ Cloud Server หลังผ่านการ Provisioning
กรณีที่ 2 ส่ง Device Activation Code / Owner Email เพื่อลงทะเบียนแสดงความเป็นเจ้าของอุปกรณ์เข้ากับบัญชีผู้ใช้ในระบบ Cloud
```
...
```text
เพราะ Protocomm Layer ถูกออกแบบตามหลักข้อตกลงในการจัดการหน่วยความจำ ให้เป็นผู้รับผิดชอบการทำลาย pointer *outbuf หลังจากนำข้อมูลใน Heap Memory ไปส่งผ่านช่องทางสื่อสารเสร็จสิ้น เพื่อป้องกันปัญหา Memory Leak ในระบบ
```
